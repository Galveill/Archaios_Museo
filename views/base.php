...
<div class="dual base">
	...
	<div>
		...
		<p>Los tesoros encontrados en el sistema Archaios son entregados al Museo mediante Terra. Todos los grupos podrán colaborar para intentar encontrarlos, viendo aquí el progreso de todos y cada uno.</p>
		<hr>
		<?php
